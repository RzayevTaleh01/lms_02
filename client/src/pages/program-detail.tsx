...
import { Plus, Download, User, Calendar, Book, Clock, MessageSquare, Star, Users } from "lucide-react";
          ...
          <div className="p-6">
            ...
            <div className="space-y-2 mb-8">
              <div className="flex items-center space-x-3 p-3 text-gray-600 hover:bg-gray-50 rounded-lg cursor-pointer">
                ...
                <span className="text-sm">Üstünlüklər barədə məlumat</span>
              </div>
              <div className="flex items-center space-x-3 p-3 text-gray-600 hover:bg-gray-50 rounded-lg cursor-pointer">
                      ...
                      <div className="pl-6 pt-2">
                        ...
                        <div className="space-y-2">
                          <div className="text-sm text-gray-600">
                            • Nəzəri hissə və əsas prinsiplər
                          </div>
                          <div className="text-sm text-gray-600">
                            • Praktiki tapşırıqlar və layihələr
                          </div>
                          <div className="text-sm text-gray-600">
