                                        ...
                                        <div className="space-y-2 text-sm">
                                          ...
                                          {isGraded && studentSubmission.feedback && (
                                            <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded">
                                              <div className="text-sm font-medium text-green-800 mb-1">Müəllim rəyi:</div>
                                              <div className="text-sm text-green-700">{studentSubmission.feedback}</div>
                                              {studentSubmission.gradedAt && (
                                                <div className="text-xs text-green-600 mt-1">
                                                  Qiymətləndirmə tarixi: {new Date(studentSubmission.gradedAt).toLocaleDateString('az-AZ')}
                                                </div>
                                              )}
                                            </div>
                                          )}
