            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle>Müəllim İdarəetməsi</CardTitle>
                  <Dialog open={isAddUserOpen} onOpenChange={setIsAddUserOpen}>
                    ...
                    <DialogContent>
                      ...
                      <div className="space-y-4">
                        ...
                        <Button 
                          onClick={() => {
                            const teacherData = {...newUserData, role: 'teacher' as const};
                            ...
                            addUserMutation.mutate(teacherData);
                          }} 
                          className="w-full"
                          disabled={addUserMutation.isPending}
                        >
                          {addUserMutation.isPending ? "Əlavə edilir..." : "Müəllim Əlavə Et"}
                        </Button>
                      </div>
                    </DialogContent>
                  </Dialog>
