...
import { LayoutDashboard, BookOpen, Users, GraduationCap, Settings, LogOut, Menu } from "lucide-react";
...
export const AdminSidebar = ({ isOpen, onClose }: AdminSidebarProps) => {
  ...
  const menuItems = [
    { icon: LayoutDashboard, label: "Ana Panel", href: "/admin", exact: true },
    { icon: BookOpen, label: "Kurslar", href: "/admin/courses" },
    { icon: GraduationCap, label: "Müəllimlər", href: "/admin/teachers" },
    { icon: Users, label: "Tələbələr", href: "/admin/students" },
    { icon: Settings, label: "Parametrlər", href: "/admin/settings" },
  ];
