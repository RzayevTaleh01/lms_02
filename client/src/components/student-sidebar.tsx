...
import { Home, GraduationCap, ClipboardList, Award, User, LogOut, Menu, Trophy } from "lucide-react";
...
export const StudentSidebar = ({ isOpen, onClose }: StudentSidebarProps) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={cn(
        "fixed left-0 top-0 h-screen w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out flex flex-col z-50",
